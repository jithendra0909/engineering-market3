  ...
  return (
    <div className="flex flex-col bg-[#EEEAF8]" style={{ minHeight: 'calc(100vh - 64px)' }}>
      ...
      <div className="flex-1 flex items-center justify-center pb-20 lg:pb-0">
        <img
          src="/images/file_000000005f8c71fdadfca5b7d4c2757e.png"
          alt="Vendors Coming Soon — We are working hard to bring something amazing for you."
